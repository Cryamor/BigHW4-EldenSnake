...
/*开始界面后的一级菜单 1 - standard game->_menu() 2 - storymode 3 - settings 4 - readLog 0 - quit*/
int Game::menu()
{
	cleardevice();
	putimage(0, 0, &IM_START);
...
void Game::setting_Dif()
{
	...
	int focus = this->dif - 1;
	//show buttons
	bu[focus].changeCond(1);
